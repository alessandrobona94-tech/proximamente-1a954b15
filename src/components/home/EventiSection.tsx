...
const archiveEvents = [
  { img: "locandina-umanita-sospesa.png", alt: "Umanità Sospesa", date: "25 Ottobre 2025 · Rivarolo Canavese", title: "Umanità Sospesa", desc: "Convegno con MSF. Salone Comunale." },
  { img: "foto-convegno.jpg", alt: "Convegno Solidarietà", date: "15 Novembre 2025 · Rivarolo", title: "Cena di Solidarietà Palestinese", desc: "Serata di raccolta fondi e cultura palestinese." },
